...
Route::get('/ejen/senarai-permohonan', [App\Http\Controllers\Ejen\PermohonanController::class, 'index'])->name('ejen.index');
Route::get('/ejen/permohonan-baru', [App\Http\Controllers\Ejen\PermohonanController::class, 'create'])->name('ejen.create');
Route::post('/ejen/permohonan-baru', [App\Http\Controllers\Ejen\PermohonanController::class, 'store'])->name('ejen.store');